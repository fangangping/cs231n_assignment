...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        ############################################################################
       	...
       	captions_in_emb, word_embedding_cache = word_embedding_forward(captions_in, W_embed)

       	if self.cell_type == 'rnn':
        	h, rnn_cache = rnn_forward(captions_in_emb, h0, Wx, Wh, b)
        elif self.cell_type == 'lstm':
        	h, rnn_cache = lstm_forward(captions_in_emb, h0, Wx, Wh, b)
    ...
    def sample(self, features, max_length=30):
        ...
        for t in range(1, max_length):
	        ...
	        if self.cell_type == 'rnn':
	        	...
	        	next_h, prev_c, temp_cache = lstm_step_forward(x_emb, prev_h, prev_c, Wx, Wh, b)
	        	prev_h = next_h
